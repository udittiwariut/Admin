...
<html lang="en">
  <head>
    ...
    <title>
      Marketing Dashboard | TailAdmin - Tailwind CSS Admin Dashboard Template
    </title>
  </head>

  <body
    x-data="{ page: 'marketing', 'loaded': true, 'darkMode': true, 'stickyMenu': false, 'sidebarToggle': false, 'scrollTop': false }"
    x-init="
        ...
        <main>
          <div class="mx-auto max-w-screen-2xl p-4 md:p-6 2xl:p-10">
            ...
            <div class="mb-5 flex items-center justify-between">
              <div>
                <h2
                  class="mb-1.5 text-title-md2 font-bold text-black dark:text-white"
                >
                  Highlights
                </h2>
                <p class="font-medium">Latest social statistics</p>
              </div>
            ...
            <div
              class="grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-6 2xl:gap-7.5"
            >
              <div
              ...
              >
                ...
                <h4 class="mb-2 mt-5 font-medium">Avg. Client Rating</h4>
                <h3
                  class="mb-2 text-title-md font-bold text-black dark:text-white"
                >
                  7.8/10
                </h3>
              ...
              >
                ...
                <h4 class="mb-2 mt-5 font-medium">Instagram Followers</h4>
                <h3
                  class="mb-2 text-title-md font-bold text-black dark:text-white"
                >
                  7.8/10
            ...
            <div class="mt-7.5 grid grid-cols-12 gap-4 md:gap-6 2xl:gap-7.5">
                  ...
                  <div class="flex flex-col">
                    ...
                    >
                      <div class="flex items-center gap-3 p-2.5 xl:p-5">
                        <div class="h-9 w-full max-w-9 flex-shrink-0">
              ...
              <!-- ===== Chart Five Start ===== -->
              <include src="./partials/chart-05.html" />
              <!-- ===== Chart Five End ===== -->

              <!-- ===== External Links Start ===== -->
              <div
                class="col-span-12 rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark xl:col-span-5"
              >
                <div
                  class="flex items-start justify-between border-b border-stroke px-6 py-5 dark:border-strokedark"
                >
                  <div>
                    <h2
                      class="mb-1.5 text-title-md2 font-bold text-black dark:text-white"
                    ...
                    <p class="text-sm font-medium">Most used resources</p>
                  </div>
                  <div x-data="{openDropDown: false}" class="relative">
                    <button @click="openDropDown = !openDropDown">
                      <svg
                ...
                <div class="px-3 pb-5">
                  <div
                    class="group flex items-center justify-between rounded-md p-4.5 hover:bg-gray-2 dark:hover:bg-graydark"
                  >
                    <div class="flex items-center gap-4">
                      ...
                      <a href="#">
                        <h4
                          class="font-medium text-black group-hover:text-primary dark:text-white dark:group-hover:text-primary"
                        >
                          Google Analytics
                        </h4>
                      </a>
                    ...
                    <a href="#" class="inline-block hover:text-primary">
                      <svg
                        class="fill-current"
                        width="16"
                        height="16"
              ...
              >
                ...
                <div
                  x-data="
                      ...
                      "
                  class="px-6 pb-7.5 pt-6"
                >
                  <!-- Featured Tab Buttons -->
                  <div class="mb-5.5 flex flex-wrap items-center gap-3.5">
                    <button
                      class="inline-flex items-center gap-3 rounded-md border px-4.5 py-2 font-medium hover:border-primary hover:bg-primary/[0.08] hover:text-primary"
                  ...
                  <div>
                    ...
                    <div
                      class="grid gap-1 rounded bg-gray-2 px-4.5 py-2 dark:bg-graydark xsm:grid-cols-7 sm:grid-cols-5"
                    >
                      ...
                      <div class="xsm:col-span-2 sm:col-span-1">
                        <h4
                          class="text-sm font-medium uppercase xsm:text-right"
                        >
                          CONVERSION
                        </h4>
                      </div>
                    ...
                    <div
                      x-show="openTab === 1"
                      class="mt-4.5 flex flex-col gap-6"
                    >
                      <!-- Featured Tab Content Item -->
                      <div
                        class="grid gap-1 px-4.5 xsm:grid-cols-7 sm:grid-cols-5"
                      >
                        <div class="xsm:col-span-3">
                          <h5
                            class="cursor-pointer text-sm font-medium text-black hover:text-primary dark:text-white dark:hover:text-primary"
                          >
                        ...
                        <div class="xsm:col-span-2 sm:col-span-1">
                          <span
                            class="inline-block rounded bg-meta-8/[0.08] px-2.5 py-1 text-sm font-medium text-meta-8"
                            >In Queue</span
                          >
                        </div>
                        <div
                          class="xsm:col-span-2 xsm:text-right sm:col-span-1"
                        >
                          <span
                            class="inline-block text-sm font-medium text-black dark:text-white"
                            >0%(0)</span
                          >
                        </div>
                      </div>
                      ...
                      >
                        ...
                        <div class="xsm:col-span-2 sm:col-span-1">
                          <span
                            class="inline-block rounded bg-meta-3/[0.08] px-2.5 py-1 text-sm font-medium text-meta-3"
                            >Sent</span
                          >
                        </div>
                        <div
                      ...
                      >
                        ...
                        <div class="xsm:col-span-2 sm:col-span-1">
                          <span
                            class="inline-block rounded bg-primary/[0.08] px-2.5 py-1 text-sm font-medium text-primary"
                            >In Draft</span
                          >
                        </div>
                        <div
              ...
              >
                ...
                <div class="p-6">
                  <div class="flex flex-col gap-7">
                    <div class="relative z-1 flex gap-5.5">
                      <div
                        class="h-16 w-full max-w-16 rounded-full border-[3px] border-stroke dark:border-strokedark"
                      >
                        <img src="./images/user/user-14.png" alt="User" />
                      </div>

                      <div>
                        <p class="text-black dark:text-white">
                          <span class="font-medium">Timothy Smith</span>
                          Commented on Cloud
                          <span class="font-medium">Killan James</span>
                        </p>
                        <span class="mt-1 block text-sm">1 hour ago</span>
                        <p class="mt-2.5 text-black dark:text-white">
                      ...
                      <span
                        class="absolute left-8 -z-1 block h-[300%] w-[1px] border-l border-dashed border-stroke dark:border-strokedark"
                      ></span>
                    </div>
                    ...
                    <div class="relative z-1 flex gap-5.5">
                      <div
                        class="h-16 w-full max-w-16 rounded-full border-[3px] border-stroke dark:border-strokedark"
                      >
                        <img src="./images/user/user-15.png" alt="User" />
                      </div>

                      <div>
                        <p class="text-black dark:text-white">
                          <span class="font-medium">Nancy Martino</span>
                          Commented on Cloud
                          <span class="font-medium">Matney</span>
                        </p>
                        <span class="mt-1 block text-sm">2 hour ago</span>
                        <p class="mt-2.5 text-black dark:text-white">
                    ...
                    <div class="relative z-1 flex gap-5.5">
                      <div
                        class="h-16 w-full max-w-16 rounded-full border-[3px] border-stroke dark:border-strokedark"
                      >
                        <img src="./images/user/user-16.png" alt="User" />
                      </div>

                      <div>
                        <p class="text-black dark:text-white">
                          <span class="font-medium">Michael Morris</span>
                          Commented on
                          <span class="font-medium">Williams Son</span>
                        </p>
                        <span class="mt-1 block text-sm">3 hour ago</span>
                        <p class="mt-2.5 text-black dark:text-white">
                          There are many variations of passages of Lorem Ipsum.
                        </p>
                      </div>
