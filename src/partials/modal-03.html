...
>
  <div
    ...
    class="relative w-full max-w-142.5 rounded-lg bg-primary px-8 py-12 text-center md:px-17.5 md:py-15"
  >
    ...
    <a
      href="#"
      class="inline-block rounded border border-white px-12.5 py-3 text-center font-medium text-white transition hover:bg-white hover:text-primary"
    >
      Know More
    </a>
    <button
      @click="modalOpen = false"
      class="absolute right-6 top-6 flex h-7 w-7 items-center justify-center rounded-full bg-white/10 text-white transition hover:bg-white hover:text-primary"
    >
      <svg
        width="10"
        height="10"
