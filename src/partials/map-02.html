...
>
  ...
  >
    ...
    <div class="items-center sm:flex">
      <div class="flex w-full max-w-42.5 items-center gap-3.5">
        <img src="./images/country/country-02.svg" alt="canada" />
    ...
    <div class="items-center sm:flex">
      <div class="flex w-full max-w-42.5 items-center gap-3.5">
        <img src="./images/country/country-03.svg" alt="france" />
    ...
    <div class="items-center sm:flex">
      <div class="flex w-full max-w-42.5 items-center gap-3.5">
        <img src="./images/country/country-04.svg" alt="italy" />
    ...
    <div class="items-center sm:flex">
      <div class="flex w-full max-w-42.5 items-center gap-3.5">
        <img src="./images/country/country-05.svg" alt="australia" />
    ...
    <div class="items-center sm:flex">
      <div class="flex w-full max-w-42.5 items-center gap-3.5">
        <img src="./images/country/country-06.svg" alt="india" />
